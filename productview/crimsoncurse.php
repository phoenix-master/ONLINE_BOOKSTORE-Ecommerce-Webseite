...
<!--product details-->
 <aside class="3">
    <img src="../imagess/crimson.jpg" alt="crimson book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">The Crimson Curse </span><span style="color:#ff3300">Paperback</span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Melissa J.Crispin</span></p>
    <hr>

    <a href="#"><p>> see all formats edition</p></a>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Paperback<br>₹ 151.85</p><br>

    <p>Delivery By: Tuesday,December 10 <a href="#">Details</a><span></span></p>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;">₹ 151.85<br>
...
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
    Cursed and disfigured, Calliope must find true love before the final leaf falls fromthe Enchanted Tree.<button id="sh">Read more...</button>
    <p id="pp">Being bound to her mansion on the outskirts of town leaves her with little hope.
...
Yareena and the mansion staff do their best at matchmaking, but Calliope can't reveal her darkest secret. Will Bastian discover her true beauty before it’s too late?</p>
