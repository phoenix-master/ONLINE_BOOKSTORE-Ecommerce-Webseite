...
<!--product details-->
 <aside class="3">
    <img src="../imagess/whispers.png" alt="Courts fool book cover page" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 25px;">Whispers of Hate </span><span style="color:#ff3300;">Paperback</span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Sanchit Garg</span></p>
    <hr>
    ...
    <p>Delivery By: Saturday,December 15 <a href="#">Details</a><span></span></p>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;">₹ 750<br>
    M.R.P: <del>₹850 </del><br>
    You save: ₹ 200<br>
...
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
    <strong>A true heart-wrenching tale of love, suspense, mystery, thriller and horror.<br>
Do you believe in the otherworldly?<br>
