...
<!--product details-->
 <aside class="3">
    <img src="../imagess/courtsfool.png" alt="Courts fool book cover page" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 25px;">Court's Fool </span><span style="color:#ff3300;">Paperback</span></h2>
    ...
    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Paperback<br>₹ 325</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;">₹ 325<br>
    M.R.P: <del>₹ 425</del><br>
    You save: ₹ 100<br>
...
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
    <strong>Death becomes the queen.</strong> 
...
<button id="sh">Read more...</button>
    <p id="pp"><strong>Outnumbered and outgunned, Tehl and Sage have to make the most difficult decision of their existence; follow their moral code, or give into the darkness and end Zane's tyranny once and for all.</strong>

<em>Court's Fool by Frost Kay returns to the spellbinding world of Aermia for a pulse pounding conclusion to the The Aermian Feuds that's perfect for fans of Sarah J. Maas and Holly Black!</em></p>
