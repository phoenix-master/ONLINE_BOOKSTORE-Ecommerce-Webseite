...
<!--product details-->
 <aside class="3">
    <img src="../imagess/asylum.png" alt="Courts fool book cover page" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 25px;">Asylum </span><sub style="font-size:10px;">once you enter you'll never leave</sub><span style="color:#ff3300;">Paperback</span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Madeleine Roux</span></p>
    <hr>

    <a href="#"><p>> see all formats edition</p></a>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Paperback<br>₹ 750</p><br>

    <p>Delivery By: Saturday,Novemeber 15 <a href="#">Details</a><span></span></p>
...
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
    <strong>Madeleine Roux's New York Times bestselling Asylum is a thrilling and creepy photo-illustrated novel that Publishers Weekly called "a strong YA debut that reveals the enduring impact of buried trauma on a place."</strong><br>
