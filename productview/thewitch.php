...
<!--product details-->
 <aside class="3">
    <img src="../imagess/thewitch.jpg" alt="Courts fool book cover page" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 25px;">The Witch </span><span style="color:#ff3300;">Paperback</span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Robinson Fowler</span></p>
    <hr>

    <a href="#"><p>> see all formats edition</p></a>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Paperback<br>₹ 410</p><br>

    <p>Delivery By: Saturday,Novemeber 29 <a href="#">Details</a><span></span></p>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;">₹ 410<br>
    M.R.P: <del>₹520 </del><br>
    You save: ₹ 120<br>
...
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
    <strong>When the youngest of the Morgan children, Annie, turned eight she didn't know the fate that would await her. </strong><br>
<button id="sh">Read more...</button>
    <p id="pp">
   As they enter the forest, she and her brother, Bill, will experience unspeakable terror. Only her ties will be able to save them... because she has waited for them for a long time, in a forest flooded by her everlasting evil... THE WITCH...
  </p>
