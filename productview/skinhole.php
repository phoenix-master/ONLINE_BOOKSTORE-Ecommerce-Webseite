...
<body>
  ...
  <ul class="navbar-nav">
   <li class="nav-item">
      <a class="nav-link" href="#"><button type="button" class="btn btn-light bt" style="width:100px;">Login</button></a>
   </li>
   <li class="nav-item" style="margin-left:10px;font-weight: bold">
    <a class="nav-link" href="#">More</a>
   </li>
   <li class="nav-item icn">
      <a class="nav-link" href="../user/missingcart.php"><i style="font-size:35px;margin-left:20px;"class="fas fa-cart-plus"></i></a>
   </li>
  </ul>
</nav>
<section class="row">
...
<!--product details-->
 <aside class="3">
    <img src="../imagess/ghost.jpg" alt="Courts fool book cover page" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 25px;">Live-in With a ghost </span><span style="color:#ff3300;">Paperback</span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Cassandra Clare</span></p>
    <hr>

    <a href="#"><p>> see all formats edition</p></a>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Paperback<br>₹ 624</p><br>

    <p>Delivery By: Saturday,January 25 <a href="#">Details</a><span></span></p>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;">₹ 624<br>
    M.R.P: <del>₹824 </del><br>
    You save: ₹ 200<br>
...
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
    Jia & Jai have a unique love story where she is human and he is a ghost. They meet during an out-of-body experience after an accident. Although from different worlds, she is simple middle-class journalist and he is a rich playboy, they fall in love instantly.
<button id="sh">Read more...</button>
    <p id="pp">
      During the adventure of their relation they both go through various exciting events which include tears, laughter, love and even fighting-off goons. Throughout their relation, the only thing Jia fears is what if he wakes up and forgets her. And in the end of the story he does wake up but if he remembers her is yet to be known..
  </p>
