          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">kitaab.com</span>
      ...
      <form action="updatefetch.php" method="post" enctype="multipart/form-data" style="color:black;">
        ...
        <p>category:
          <select name="type">
              ...
              <option value="entranceexamguides">Entrance exam guides</option>
              <option value="kids">Kids</option>
              <option value="holybooks">Holy Books</option>
            
          </select>
        </p>
        <p>Description:</p>
        <textarea name="edittext" value="<?php echo $row['description']; ?>"></textarea>
        <br>
        <div>
          <p>Upload image:</p>
